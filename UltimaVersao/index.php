      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="planos" style="font-weight: bold;">Planos</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="login" style="font-weight: bold;">login</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item"  href="registrar" style="font-weight: bold;">registrar</a></li>
              </ul>
            </li>
          </ul>
          <form class="container-fluid d-flex justify-content-start justify-content-md-end px-0">
            <button class="btn btn-sm btn-outline btn-primary m-0" type="button"><a style="text-decoration: none; color: white;" href="registrar" style="font-weight: bold;">Cadastre-se</a></button>
            <button class="btn btn-outline me-2 mx-2 btn-info"  type="button"><a style="text-decoration: none; color: white;" href="login" style="font-weight: bold;">Entrar</a></button>
          </form>
        </div>
      </div>
    </nav>
...
?>
  ...
  <footer class="">
    ...
    <div class="redes">
      ...
      <a href="https://www.instagram.com/vinicius_ferreira254?igsh=MXNvOWduNXY3eGxuOQ=="><i class="fa-brands fa-instagram"></i></a>
