      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-user"><?php echo $email; ?></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="catalogo.html">Home</a>
            </li>
            <li class="nav-item">
  ...
  <main>
    ...
    <div class="des">
        ...
        <div class="swiper__flex">
            <div class="swiper outroSwiper">
            <!-- Additional required wrapper -->
            <div class="swiper-wrapper">
              <!-- Slides -->
              <div class="swiper-slide"><a class="swiper-slide" href="pages.html"><img src="../imagens/dino.jpeg"></div></a>
              <div class="swiper-slide"><a class="swiper-slide" href="pages.html"><img src="../imagens/dino1.jpg"></div></a>
              <div class="swiper-slide"><a class="swiper-slide" href="pages.html"><img src="../imagens/jogo do ninja.png"></div></a>
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              <div class="swiper-slide"><img src="../imagens/dino.jpeg"></div>
              <div class="swiper-slide"><img src="../imagens/dino1.jpg"></div>
              <div class="swiper-slide"><img src="../imagens/outroJogo.jpeg"></div>
